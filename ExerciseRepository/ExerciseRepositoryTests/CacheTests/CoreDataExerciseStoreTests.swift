...
class CoreDataExerciseStoreTests: XCTestCase {
    ...
    func test_coreDataExerciseStore_insertExerciseFailure_hasNoSideEffects() throws {
    ...
    func test_coreDataExerciseStore_deleteExerciseFailure_hasNoSideEffects() throws {
